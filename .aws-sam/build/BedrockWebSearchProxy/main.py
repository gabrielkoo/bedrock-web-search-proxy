...
# ---------------------------------------------------------------------------
# Model config — all aliases route to Nova Premier (only grounding model)
# ---------------------------------------------------------------------------
_NOVA_PREMIER = "us.amazon.nova-premier-v1:0"

MODEL_MAP: dict[str, str] = {
    "nova-premier-web-grounding": _NOVA_PREMIER,  # canonical name
    "sonar-pro":                  _NOVA_PREMIER,
    "sonar-pro-online":           _NOVA_PREMIER,
    "sonar-reasoning-pro":        _NOVA_PREMIER,
    "sonar-deep-research":        _NOVA_PREMIER,
    "sonar":                      _NOVA_PREMIER,
    "sonar-online":               _NOVA_PREMIER,
    "sonar-reasoning":            _NOVA_PREMIER,
    "sonar-turbo":                _NOVA_PREMIER,
    "sonar-mini":                 _NOVA_PREMIER,
    "nova-premier-grounding":     _NOVA_PREMIER,
    "nova-pro-grounding":         _NOVA_PREMIER,
    "nova-lite-grounding":        _NOVA_PREMIER,
}
DEFAULT_MODEL_ID = _NOVA_PREMIER
